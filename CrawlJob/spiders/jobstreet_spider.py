...
#             url=url, callback=self.parse_search_results, meta={"keyword": self.keyword}
#         )
...
#         for href in job_results_section.css(
#             'a[class*="job-link"]::attr(href)'
#         ).getall():
#             if href:
#                 job_links.add(href)
...
#             yield response.follow(
#                 next_href, callback=self.parse_search_results, meta=response.meta
#             )
...
#             'div.badge.-default-badge div[class*="content"]::text'
#         ).get()
...
#             response.css("div#job-description-container ::text").getall()
#         )
